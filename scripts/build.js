...
<body>
  <header>
    ...
    <p style="margin: 8px 0 0 0; font-size: 14px; color: #999;">If you're employed, consider buying <a href="https://cottonbureau.com/people/advent-of-code" target="_blank" rel="noopener noreferrer" style="color: #39ff14;">real merch</a></p>
    <button title="Toggle sound" id="audioToggle" style="position: absolute; top: 20px; right: 20px; padding: 8px 16px; cursor: pointer; font-size: 14px;">🔊 Sound On</button>
  </header>
